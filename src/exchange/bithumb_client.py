...
class BithumbClient:
    ...
    def _prepare_private_request(
        self,
        path: str,
        payload: Optional[MutableJsonMapping],
        ...
        payload_to_send["endpoint"] = path

        nonce = self._generate_nonce()
        signature = self._create_signature(path, nonce, payload_to_send)
        headers = {
    ...
    def request(
        ...
        *,
        ...
        if private:
            request_data, auth_headers = self._prepare_private_request(path, request_data)
